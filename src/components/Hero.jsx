...
function Hero() {
  return (
    ...
    <div
      ...
      <div className="relative mx-auto pb-10 px-4 py-24 z-10 lg:p-20 mt-36 lg:ml-52 ml-7">
      <h1 className="text-5xl font-bold mb-6 animate-fade-in-up text-white lg:text-6xl">Transform your ideas into reality</h1>
