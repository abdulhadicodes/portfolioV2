...
const ScrollToTop = () => {
  ...
  return (
    <button
      ...
      className={`fixed bottom-5 index-50 right-5 p-3 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-500 ${
